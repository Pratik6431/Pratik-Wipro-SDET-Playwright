...
class Storage<T> {
    ...
    getItem(index: number): T {
        return this.items[index]!; // non-null assertion operator to indicate that the item will
        // exist at the given index
    }
}

const names = new Storage<string>();
names.addItems("Pratik");
names.addItems("Nitish");
names.addItems("Adil");

console.log(names.getItem(0), names.getItem(1), names.getItem(2), names.getItem(3)); // undefined for
// index 3
...
logLength("Pratik"); // string --> length
