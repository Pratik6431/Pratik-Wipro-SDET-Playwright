...
// destructuring
// const arr = ["Pratik", "Adil", "Nitish", "Shivam"];
// const first = arr[0];
// const second = arr[1];
// const third = arr[2];
// const fourth = arr[3];

const [first, second, third, fourth, fifth] = ["Pratik", "Adil", "Nitish", "Shivam"]; // pos-based extraction
const [one, two, ...three] = [1, 3, 5, 6, 7];
console.log(first, second, third, fourth, fifth);
console.log(one, two, three)

const { name, age } = {name: "pratik", age: 23}; // key-based extracted
